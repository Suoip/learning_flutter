...
class SmartAcademyAuthPage extends StatefulWidget {
  const SmartAcademyAuthPage({super.key, required this.onAuthenticated});

  final Future<void> Function() onAuthenticated;

  @override
  State<SmartAcademyAuthPage> createState() => _SmartAcademyAuthPageState();
}

class _SmartAcademyAuthPageState extends State<SmartAcademyAuthPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      if (_isRegister) {
        ...
        if (!authenticated) {
          setState(() {
            ...
            _infoText = 'Educator account created. Check your email to '
                'confirm it, then log in with your email.';
          });
          return;
        }
      } else {
      ...
      setState(() {
        _loading = false;
        _errorText = EducatorLogic.userMessageForError(
          error,
  ...
  Future<void> _resendConfirmationEmail() async {
    ...
    if (!EducatorLogic.isValidEmail(email)) {
      setState(() {
          ...
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  const Text(
                    "Enter your educator account email and we'll send you a "
                  ...
                  onPressed: sending
                      ...
                      : () async {
                          ...
                          try {
                            ...
                            setDialogState(() {
                              sending = false;
                              dialogError = EducatorLogic.userMessageForError(
                                error,
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text(
                            'Sign in with email, or register with username, '
                            'email, and password to manage SmartAcademy content.',
                            textAlign: TextAlign.center,
                          ...
                          if (_isRegister) ...[
                            TextFormField(
                              ...
                              validator: (value) {
                                ...
                                if (!EducatorLogic.isValidUsername(input)) {
                          ...
                          TextFormField(
                            ...
                            validator: (value) {
                              ...
                              if (!EducatorLogic.isValidEmail(input)) {
