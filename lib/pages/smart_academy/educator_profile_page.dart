...
import 'educator_avatar_section.dart';
import 'educator_password_form_section.dart';
import 'educator_username_form_section.dart';
...
class _EducatorProfilePageState extends State<EducatorProfilePage> {
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      final profile = await _logic.fetchCurrentEducatorProfile();
      if (!mounted) return;
  ...
  Future<void> _pickAndUploadAvatar() async {
    ...
    final sanitizedExtension = EducatorLogic.extensionFromFileName(picked.name);
    ...
    try {
      ...
      final updatedProfile = await _logic.uploadEducatorAvatar(
        bytes: bytes,
